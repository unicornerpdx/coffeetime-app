...
.factory('Session', function(Config, UUID, $ionicPlatform, $http, $state, Cache){
  if(!Cache.token()){
    $state.go('auth', {
      location: "replace"
    });
  ...
  function updateTokens() {
    ...
    if($ionicPlatform.is('android')){
      ...
      pushNotification.register(androidHandler, pushError, {
    ...
    if($ionicPlatform.is('ios')){
      pushNotification.register(iosHandler, pushError, {
        "badge":"true",
        "sound":"true",
        "alert":"true",
