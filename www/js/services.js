...
.factory('Activity', function() {
  ...
  var activities = [
    ...
    { id: 1, user: { name: 'Nate Goldman', username: 'ngoldman', photo: 'https://avatars1.githubusercontent.com/u/427322?s=460'}, amount: -2, date: '2014-02-27T18:30:12-0800', message: 'better pay me back, yo', latlng: [-120.277, 45.235]  },
    { id: 2, user: { name: 'Nikolas Wise', username: 'nikolaswise', photo: 'https://avatars2.githubusercontent.com/u/1987772?s=460'}, amount: 1, date: '2014-01-27T18:04:00-0800', message: 'thanks for the coffee', latlng: [-120.277, 45.235]  },
    { id: 3, user: { name: 'Patrick Arlt', username: 'patrickarlt', photo: 'https://avatars1.githubusercontent.com/u/378557?s=460'}, amount: 2, date: '2013-12-14T14:00:00-0800', message: '', latlng: [-120.277, 45.235]  },
  ];
